            ...
            <View style={styles.body}>
                <ScrollView style={{ flex: 1 }}>
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center' }}>
                        <TouchableOpacity onPress={() => this.goSelectedColor(require('../images/cvExamplesImg/templateCV1.png'), 1)}><SImage width={160} style={{ margin: 10, marginTop: 25 }} source={require('../images/cvExamplesImg/templateCV1.png')} /></TouchableOpacity>
                        <TouchableOpacity onPress={() => this.goSelectedColor(require('../images/cvExamplesImg/templateCV2.png'), 2)}><SImage width={160} style={{ margin: 10, marginTop: 25 }} source={require('../images/cvExamplesImg/templateCV2.png')} /></TouchableOpacity>

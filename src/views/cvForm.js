            ...
            <div style="width: 50%" align="center">
                <div style="margin-bottom: 25px;padding:0 20px 0 20px">
                    ...
                    ${helper.userSchools.map((item, i) => `<div>
                       <p style="font-family: Calibri;font-size: 19px;margin: 2px;color:${helper.selectedCVColor === '#FFFFFF' ? '#505050' : '#fff'}">${item.schoolName}</p>
                       <p style="font-family: Calibri;font-size: 17px;margin: 2px;color:${helper.selectedCVColor === '#FFFFFF' ? '#646464' : '#fff'}">${item.schoolDepartment}</p>
                ...
                <div style="margin-bottom: 25px;padding:0 20px 0 20px">
                    ...
                    ${helper.userProjects.map((item, i) => `<div>
                       <p style="font-family: Calibri;font-size: 19px;margin: 2px;color:${helper.selectedCVColor === '#FFFFFF' ? '#505050' : '#fff'}">${item.projectName}</p>
                       ...
                       <p style="font-family: Calibri;font-size: 17px;margin: 5px 0 2px 0;color:${helper.selectedCVColor === '#FFFFFF' ? '#646464' : '#fff'}"><span style="color:${helper.selectedCVColor === '#FFFFFF' ? '#505050' : '#fff'}">Araçlar:</span>${item.projectTools}</p>
                ...
                <div style="margin-bottom: 25px;padding:0 20px 0 20px">
                    ...
                    <div style="display: flex;justify-content: center">
                        ${helper.UserLanguages.map((item, i) => `<div>
                           <div>
                               <p style="text-align:start;margin:2px;font-family: Calibri;color:${helper.selectedCVColor === '#FFFFFF' ? '#505050' : '#fff'};font-size: 19px">${item.name}</p>
                           </div>

    ...
    @page{ 
        ...
        if (helper.selectedOrderCV === 4) {
            ...
            options = {
                ...
                <div id="myDiv" style="width: 100%;height: 850px;background-color: ${helper.selectedCVColor}">
        ...
        <div style="width: 100%;min-height: 40px;background-color: ${helper.selectedCVColor === '#FFFFFF' ? '#12A3D0' : '#fff'};display: flex;justify-content: space-between;align-items: center;flex-wrap: wrap;padding:0 25px 0 25px;box-sizing: border-box">
            ${helper.userGithubLink !== '' ? `<div style="margin:0 5px 0 5px;display: flex;align-items: center">
                ...
                <p style="color:${helper.selectedCVColor};font-family: Calibri;margin:0 0 0 5px;font-size: 22px">${helper.userGithubLink}</p>
            </div>` : ``}
            ...
            ${helper.userLinkedInLink !== '' ? `<div style="margin:0 5px 0 5px;display: flex;align-items: center">
               ...
               <p style="font-family: Calibri;font-size: 22px;color:${helper.selectedCVColor};margin: 3px 3px 3px 7px;">${helper.userLinkedInLink}</p>
            </div>` : ``}
            ...
            ${helper.userPinterestLink !== '' ? `<div style="margin:0 5px 0 5px;display: flex;align-items: center">
               ...
               ${helper.selectedCVColor === '#299BE8' ? `<img height="17px" src="data:image/svg+xml;base64," />` : ``}
               ${helper.selectedCVColor === '#407F92' ? `<img height="17px" src="data:image/svg+xml;base64," />` : ``}
               <p style="font-family: Calibri;font-size: 22px;color:${helper.selectedCVColor};margin: 3px 3px 3px 7px;">${helper.userPinterestLink}</p>
            </div>` : ``}
            ...
            ${helper.userTelegramLink !== '' ? `<div style="margin:0 5px 0 5px;display: flex;align-items: center">
               ...
               ${helper.selectedCVColor === '#299BE8' ? `<img height="17px" src="data:image/svg+xml;base64," />` : ``}
               ${helper.selectedCVColor === '#407F92' ? `<img height="17px" src="data:image/svg+xml;base64," />` : ``}
               <p style="font-family: Calibri;font-size: 22px;color:${helper.selectedCVColor};margin: 3px 3px 3px 7px;">${helper.userTelegramLink}</p>
            </div>` : ``}
            ...
            ${helper.userInstagramLink !== '' ? `<div style="margin:0 5px 0 5px;display: flex;align-items: center">
               ...
               ${helper.selectedCVColor === '#299BE8' ? `<img height="17px" src="data:image/svg+xml;base64," />` : ``}
               ${helper.selectedCVColor === '#407F92' ? `<img height="17px" src="data:image/svg+xml;base64," />` : ``}
               <p style="font-family: Calibri;font-size: 22px;color:${helper.selectedCVColor};margin: 3px 3px 3px 7px;">${helper.userInstagramLink}</p>
            </div>` : ``}
            ...
            ${helper.userYoutubeLink !== '' ? `<div style="margin:0 5px 0 5px;display: flex;align-items: center">
               ...
               ${helper.selectedCVColor === '#299BE8' ? `<img height="17px" src="data:image/svg+xml;base64," />` : ``}
               ${helper.selectedCVColor === '#407F92' ? `<img height="17px" src="data:image/svg+xml;base64," />` : ``}
               <p style="font-family: Calibri;font-size: 22px;color:${helper.selectedCVColor};margin: 3px 3px 3px 7px;">${helper.userYoutubeLink}</p>
            </div>` : ``}
            ...
            ${helper.userSkypeLink !== '' ? `<div style="margin:0 5px 0 5px;display: flex;align-items: center">
               ...
               ${helper.selectedCVColor === '#299BE8' ? `<img height="17px" src="data:image/svg+xml;base64," />` : ``}
               ${helper.selectedCVColor === '#407F92' ? `<img height="17px" src="data:image/svg+xml;base64," />` : ``}
               <p style="font-family: Calibri;font-size: 22px;color:${helper.selectedCVColor};margin: 3px 3px 3px 7px;">${helper.userSkypeLink}</p>
            </div>` : ``}
            ...
            ${helper.userFacebookLink !== '' ? `<div style="margin:0 5px 0 5px;display: flex;align-items: center">
               ...
               ${helper.selectedCVColor === '#299BE8' ? `<img height="17px" src="data:image/svg+xml;base64," />` : ``}
               ${helper.selectedCVColor === '#407F92' ? `<img height="17px" src="data:image/svg+xml;base64," />` : ``}
               <p style="font-family: Calibri;font-size: 22px;color:${helper.selectedCVColor};margin: 3px 3px 3px 7px;">${helper.userFacebookLink}</p>
            </div>` : ``}
            ...
            ${helper.userTwitterLink !== '' ? `<div style="margin:0 5px 0 5px;display: flex;align-items: center">
               ...
               ${helper.selectedCVColor === '#299BE8' ? `<img height="17px" src="data:image/svg+xml;base64," />` : ``}
               ${helper.selectedCVColor === '#407F92' ? `<img height="17px" src="data:image/svg+xml;base64," />` : ``}
               <p style="font-family: Calibri;font-size: 22px;color:${helper.selectedCVColor};margin: 3px 3px 3px 7px;">${helper.userTwitterLink}</p>
            </div>` : ``}
            ...
            ${helper.userPersonalLink.map((item, i) => `<div style="display: ${helper.userPersonalLink.length > 0 ? 'flex' : 'none'};margin:0 5px 0 5px;align-items: center">
               ...
               <p style="font-family: Calibri;font-size: 22px;color:${helper.selectedCVColor};margin: 3px 3px 3px 7px;">${item.link}</p>
            </div>`.trim()).join('')}
        ...
        <div style="width: 100%;min-height: 200px;display: flex">
           ...
           <div style="width: 65%;min-height: 200px;">
               <div style="width: 60%;margin:40px 10px 0 50px">
                    ...
                    <div style="display: flex;align-items: center">
                       ${helper.selectedCVColor === '#FFFFFF' ? `<img height="19px" width="20px" src="data:image/svg+xml;base64," /> ` :
                        `<img height="19px" width="20px" src="data:image/svg+xml;base64," />`}
                       ${helper.userDrivingLicencies.map((item, i) => `<p style="font-family: Calibri;font-size: 19px;margin:2px 0 0 5px;color:${helper.selectedCVColor === '#FFFFFF' ? '#737373' : '#fff'}">${item.licence}</p>`.trim()).join('')}
                    </div>
               </div>
           </div>
        ...
        <div style="width: 100%;display: flex">
            <div style="width: 50%" align="center">
                <div style="margin-bottom: 25px;padding:0 20px 0 20px">
                    ...
                    ${helper.userSchools.map((item, i) => `<div>
                       <p style="font-family: Calibri;font-size: 20px;margin: 5px 0 0 0;color:${helper.selectedCVColor === '#FFFFFF' ? '#505050' : '#fff'}">${item.schoolName}</p>
                       <p style="font-family: Calibri;font-size: 15px;margin: 2px;color:${helper.selectedCVColor === '#FFFFFF' ? '#646464' : '#fff'}">${item.schoolDepartment}</p>
                       <p style="font-family: Calibri;font-size: 15px;margin: 2px;color:${helper.selectedCVColor === '#FFFFFF' ? '#646464' : '#fff'}">${item.schoolGrade}</p>
                       <p style="font-family: Calibri;font-size: 12px;margin: 2px;color:${helper.selectedCVColor === '#FFFFFF' ? '#646464' : '#fff'}">${item.schoolStartDate} - ${item.schoolFinishDate}</p>
                    </div>`.trim()).join('')}
                </div>

                ${helper.userProjects.length > 0 ? `<div style="margin-bottom: 25px;padding:0 20px 0 20px">
                    ...
                    ${helper.userProjects.map((item, i) => `<div>
                       <p style="font-family: Calibri;font-size: 19px;margin:5px 0 0 0;color:${helper.selectedCVColor === '#FFFFFF' ? '#505050' : '#fff'}">${item.projectName}</p>
                       <p style="font-family: Calibri;font-size: 17px;margin: 3px 0;color:${helper.selectedCVColor === '#FFFFFF' ? '#646464' : '#fff'}">${item.projectDescription}</p>
                       ${item.projectTools !== '' ? `<p style="font-family: Calibri;font-size: 17px;margin: 5px 0 2px 0;color:${helper.selectedCVColor === '#FFFFFF' ? '#646464' : '#fff'}"><span style="color:${helper.selectedCVColor === '#FFFFFF' ? '#505050' : '#fff'}">Araçlar:</span>${item.projectTools}</p>` : ``}
                        ${item.projectLink !== '' ? `<div style="display: flex;align-items: center;justify-content: center">
                         ${helper.selectedCVColor === '#FFFFFF' ? `<img height="16px" src="data:image/svg+xml;base64," />` :
                                        `<img height="16px" src="data:image/svg+xml;base64," />`}
                         <p style="font-family: Calibri;font-size: 17px;margin: 2px 0 0 5px;color:${helper.selectedCVColor === '#FFFFFF' ? '#646464' : '#fff'}">${item.projectLink}</p>
                       </div>` : ``}
                    </div>`.trim()).join('')}
                </div>` : ``}

                ${helper.UserLanguages.length > 0 ? `<div style="margin-bottom: 25px;padding:0 20px 0 20px">
                    ...
                    ${helper.UserLanguages.map((item, i) => `<div style="display: flex;justify-content: center">
                           <div style="width:50%;display:flex;justify-content:flex-end">
                               <p style="margin:2px;font-family: Calibri;color:${helper.selectedCVColor === '#FFFFFF' ? '#505050' : '#fff'};font-size: 19px">${item.name}</p>
                           </div>
                           <div style="margin-left: 10px;width:50%;display:flex;justify-content:flex-start">
                                ${item.level === 'Ana dil' ? `<div>
                                    ${helper.selectedCVColor === '#FFFFFF' ?
                                        ...
                                        `<div style="display: flex;height: 23px;margin:2px;width: 110px;align-items: center;justify-content: space-between">
                                        <div style="width: 18px;height: 18px;border-radius: 100px;background-color: #fff"></div>
                                        <div style="width: 18px;height: 18px;border-radius: 100px;background-color: #fff"></div>
                                        <div style="width: 18px;height: 18px;border-radius: 100px;background-color: #fff"></div>
                                        <div style="width: 18px;height: 18px;border-radius: 100px;background-color: #fff"></div>
                                        <div style="width: 18px;height: 18px;border-radius: 100px;background-color: #fff"></div>    
                                ...
                                ${item.level === 'Çok iyi' ? `<div>
                                    ${helper.selectedCVColor === '#FFFFFF' ?
                                        ...
                                        <div style="width: 18px;height: 18px;border-radius: 100px;background-color: #fff"></div>
                                        <div style="width: 18px;height: 18px;border-radius: 100px;background-color: #fff"></div>
                                        <div style="width: 18px;height: 18px;border-radius: 100px;border:3px solid #fff;box-sizing: border-box"></div>
                                    </div>`}
                                </div>`: ``}
            ...
            <div style="width: 50%;" align="center">
                ${helper.userCompanies.length > 0 ? `<div style="margin-bottom: 25px;padding:0 20px 0 20px">
                    <div style="position: relative;margin:15px 0 5px 0;padding-top: 35px">
                ...
                <div style="margin-bottom: 25px;padding:0 20px 0 20px">
                    ...
                    ${helper.userAbilities.map((item, i) => `<div style="display: flex;justify-content: center">
                           <div style="width:50%;display:flex;justify-content:flex-end">
                               <p style="margin:2px;font-family: Calibri;color:${helper.selectedCVColor === '#FFFFFF' ? '#505050' : '#fff'};font-size: 19px">${item.name}</p>
                           </div>
                           <div style="margin-left: 10px;width:50%;display:flex;justify-content:flex-start">
                                ${item.level === 'Profesyonel' ? `<div>
                                    ${helper.selectedCVColor === '#FFFFFF' ?
                                    `<div style="display: flex;height: 23px;margin:2px;width: 110px;align-items: center;justify-content: space-between">
                                        <div style="width: 18px;height: 18px;border-radius: 100px;background-color: #12A3D0"></div>
                                        <div style="width: 18px;height: 18px;border-radius: 100px;background-color: #12A3D0"></div>
                ...
                ${helper.userHobbies.length > 0 ? `<div style="margin-bottom: 25px;padding:0 20px 0 20px">
                    <div style="position: relative;margin:15px 0 5px 0;padding-top: 40px">
                    ...
                    <div align="center">
                        ${helper.userHobbies.map((item, i) => `<p style="margin:2px;font-family: Calibri;color:${helper.selectedCVColor === '#FFFFFF' ? '#505050' : '#fff'};font-size: 19px">${item.hobby}</p>`.trim()).join('')}
                    </div>
                </div>` : ``}

                ${helper.userReferences.length > 0 ? `<div style="margin-bottom: 25px;padding:0 20px 0 20px">
                    <div style="position: relative;margin:15px 0 5px 0;padding-top: 40px">
                    ...
                    <div>
                        ${helper.userReferences.map((item, i) => `<div>
                            <p style="margin:5px 0 2px 0;font-family: Calibri;color:${helper.selectedCVColor === '#FFFFFF' ? '#505050' : '#fff'};font-size: 19px">${item.name}</p>
                            <p style="margin:2px;font-family: Calibri;color:${helper.selectedCVColor === '#FFFFFF' ? '#646464' : '#fff'};font-size: 13px">${item.tel}</p>
                            <p style="margin:2px;font-family: Calibri;color:${helper.selectedCVColor === '#FFFFFF' ? '#646464' : '#fff'};font-size: 13px">${item.email}</p>
                            ${item.companyName !== '' ? `<p style="margin:2px;font-family: Calibri;color:${helper.selectedCVColor === '#FFFFFF' ? '#646464' : '#fff'};font-size: 13px">
                               ${helper.selectedCVColor === '#FFFFFF' ? `<img height="13px" style="margin-right:3px" src="data:image/svg+xml;base64," />` :
                                        `<img height="13px" style="margin-right:3px" src="data:image/svg+xml;base64," />`}
                               ${item.companyName}
                            </p>` : ``}
                        </div>`.trim()).join('')}

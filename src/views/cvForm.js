...
<p style="color:${helper.selectedCVColor === '#2A2A2A' ? '#fff' : '#5E5E5E'};margin:3px;font-family: Calibri">${item.link}</p></div >`.trim()).join('')
                    }

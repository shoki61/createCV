...
<p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};margin:3px;font-family: Calibri">${item.link}</p></div >`.trim()).join('')
        ...
        <div style="width: 100%;min-height: 530px;display: flex">
            <div style="width: 40%;min-height: 100%;border-right: 2px solid ${helper.selectedCVColor === '#2A2A2A' ? '#707070' : `${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'}`};background-color:${helper.selectedCVColor === '#2A2A2A' ? '#2A2A2A' : '#fff'}">
                ...
                ${helper.userAbilities.length > 0 ? `<div style="margin-bottom: 30px">
...
" />`}Eğitim
                    ...
                    ${helper.userSchools.map((item, i) => `<div style="width: 90%;margin-left: 25px;margin-top: 5px">
                        ...
                        <p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size: 14px;margin:0">${item.schoolDepartment}</p>
                        <p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size: 14px;margin:0">${item.schoolGrade}</p>
                        <p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size: 14px;margin:0">${item.schoolStartDate} - ${item.schoolFinishDate}</p>
                    </div>`.trim()).join('')}
                </div>
...
" />`}İş Deneyimi</p>
                    ...
                    <div style="width: 90%;margin-left: 25px;margin-top: 3px">
                        <p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size: 14px;margin: 2px 0 0;">${item.companyJob}</p>
                        <p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#707070' : '#fff'};font-family: Calibri;font-size: 12px;margin: 2px 0 0;">${item.companyStartDate} - ${item.companyFinishDate}</p>
                        <p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size: 14px;margin: 2px 0 0;">${item.companyDescription}</p>
                    </div>
                    <div>`.trim()).join('')}
                </div>
                <div>
...
" />`}Projeler</p>
                    ${helper.userProjects.map((item, i) => `<div><p style="color: ${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size:16px;margin: 5px 0 0 18px;">- ${item.projectName}</p>
                    <div style="width: 90%;margin-left: 25px;margin-top: 3px">
                        <p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size: 14px;margin: 2px 0 0;">Araçlar: ${item.projectTools}</p>
                        <p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size: 14px;margin: 2px 0 0;">${helper.selectedCVColor === '#FFFFFF' ? `<img height="10px" src="data:image/svg+xml;base64,
...
" />`}
                        ...
                        <p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size: 14px;margin: 2px 0 0;"> ${item.projectDescription}</p>
                    </div>
                    </div>`.trim()).join('')}
                </div>
                <div>
...
" />`}Referans</p>
                    ...
                    <div style="width: 90%;margin-left: 25px;margin-top: 3px">
                        <p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size: 14px;margin: 2px 0 0 25px;">${item.tel}</p>
                        <p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size: 14px;margin: 2px 0 0 25px;">${item.email}</p>

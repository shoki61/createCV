    ...
    @page{ 
        ...
        if (helper.selectedOrderCV === 4) {
            options = {
                ...
                <div style="width: 100%;height: 100%;background-color: ${helper.selectedCVColor}">
            ...
            <div style="width: 50%" align="center">
                ...
                ${helper.userCommunities.length > 0 ? `<div style="margin-bottom: 25px;padding:0 20px 0 20px">
                    ...
                    ${helper.userCommunities.map((item, i) => `<div>
                        <p style="font-family: Calibri;font-size: 17px;margin: 5px 0 0 0;color:${helper.selectedCVColor === '#FFFFFF' ? '#505050' : '#fff'}">${item.communityName} / <i style="color:${helper.selectedCVColor === '#FFFFFF' ? '#646464' : '#fff'}">${item.communityTitle}</i></p>

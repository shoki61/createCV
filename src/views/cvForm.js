        ...
        <div style="width: 100%;height: 130px;display: flex">
            ...
            <div style="width: 65%;height: 100%">
                ...
                <div style="display: flex;margin: 5px;margin-left: 15px">
                    <div>
                        <p style="font-size: 15px;font-family: Calibri;color:${helper.selectedCVColor === '#FFFFFF' ? '#606060' : '#fff'};margin: 0">Adı:</p>
                        <p style="font-size: 15px;font-family: Calibri;color:${helper.selectedCVColor === '#FFFFFF' ? '#606060' : '#fff'};margin: 0">Tel no:</p>
                        <p style="font-size: 15px;font-family: Calibri;color:${helper.selectedCVColor === '#FFFFFF' ? '#606060' : '#fff'};margin: 0">Email:</p>
                        <p style="font-size: 15px;font-family: Calibri;color:${helper.selectedCVColor === '#FFFFFF' ? '#606060' : '#fff'};margin: 0">Şehir:</p>
                    </div>

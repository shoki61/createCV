            ...
            <div style="width: 60%;min-height: 100%;border-left: 2px solid ${helper.selectedCVColor === '#2A2A2A' ? '#707070' : `${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'}`};padding-bottom: 25px">
                ...
                <div>
                    ...
                    ${helper.userSchools.map((item, i) => `<div style="width: 90%;margin-left: 25px;margin-top: 5px">
                        ...
                        <p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size: 13px;margin:0">${item.schoolDepartment}</p>
                        <p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size: 12px;margin:0">${item.schoolGrade}</p>
                        <p style="color:${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size: 11px;margin:0">${item.schoolStartDate} - ${item.schoolFinishDate}</p>
                    </div>`.trim()).join('')}
                </div>
                ...
                ${helper.userCommunities.length > 0 ?
                      ...
                      Topluluk</p>
                       ${helper.userCommunities.map((item, i) => `<div><p style="color: ${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size:16px;margin: 5px 0 0 15px;">- ${item.communityName} / <i style="font-size: 14px">${item.communityTitle}</i></p>
                        ...
                        ${item.communityDescription > 0 ? `<p style="color: ${helper.selectedCVColor === '#FFFFFF' ? '#5E5E5E' : '#fff'};font-family: Calibri;font-size:12px;margin: 2px 0 10px 20px;">
